...
def count1(x):
    ...
    x = (x & 0x0000FFFF0000FFFF0000FFFF0000FFFF) + ((x>>0x10) & 0x0000FFFF0000FFFF0000FFFF0000FFFF)
    x = (x & 0x00000000FFFFFFFF00000000FFFFFFFF) + ((x>>0x20) & 0x00000000FFFFFFFF00000000FFFFFFFF)
    return x
